...
public class FriendMain {
    public static void main(String[] args) throws Exception{
        ...
        TextInputFormat.addInputPath(job, new Path("file:///D:\\test\\共同好友\\output1"));
        ...
        TextOutputFormat.setOutputPath(job, new Path("file:///D:\\test\\共同好友\\output2"));
        //3.提交job等等任务结果
        //4.退出程序
