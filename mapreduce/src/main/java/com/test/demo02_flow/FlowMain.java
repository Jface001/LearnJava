...
public class FlowMain {
    public static void main(String[] args) throws Exception {
        //1.创建job任务
        Job job = Job.getInstance(new Configuration(), "flowMR01");
        //2.封装核心8步
        //2.1 封装输入组件,读取源文件数据,获取k1,v1
        job.setInputFormatClass(TextInputFormat.class);
        TextInputFormat.addInputPath(job, new Path("file:///D:\\test\\流量统计\\input\\data_flow.dat"));
        ...
        TextOutputFormat.setOutputPath(job, new Path("file:///D:\\test\\流量统计\\output01"));
        //3.提交job等等任务结果
        //4.退出程序
